...
function validarEmail(email) {
	...
	*/	
		...
		CargarAjax2_form('Admin/Sist.Administrador/Beneficiario/List/listado.php','form_edit_bene','cargaajax');
...
<form action="" method="post" enctype="multipart/form-data" id="form_edit_bene">
         ...
         <label class="strong">Nombre<span class="label label-important" id="Nombres" style="display:none">*</span></label>
          ...
          <label class="strong">Teléfono <span class="label label-important" id="Nombres" style="display:none">*</span></label>
                 ...
                 <label class="strong">Confirmar Contraseña<span class="label label-important" id="Nombres" style="display:none">*</span></label>
                     <div class="form-group ">
                                ...
                                <div class="tab-pane fade" id="beneficios">
                                    ...
                                    <div class="row">
                  <div class="col-lg-6">
                 <label class="strong">% de venta<span class="label label-important" id="Nombres" style="display:none">*</span></label>
                     <div class="form-group ">
			...
			<? } ?>
                ...
                <input name="funcion_id" type="hidden" id="funcion_id" value="7" />
