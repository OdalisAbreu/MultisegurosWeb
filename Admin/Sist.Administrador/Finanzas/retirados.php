...
<div class="row" >
    <div class="col-lg-12" style="margin-top:-35px;">
        <h3 class="page-header">Listados de saldos retirados a Clientes</h3>
    </div>
</div>
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.Administrador/Finanzas/retirados.php?fecha1='+fecha1+'&fecha2='+fecha2+'','','GET','cargaajax');
...
$query=mysql_query("
   ...
   WHERE autorizada_por ='".$_SESSION['user_id']."' $wFecha order by id DESC");
