...
<div class="row" >
    <div class="col-lg-12">
        <h3 class="page-header" style="margin-top: 5px;">Listados de saldos recargados / retirados / creditos / ingresos a operadores</h3>
    </div>
    <? if($_GET['id']){?>
    <div class="col-lg-12">
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.Administrador/Opciones/recargados.php?fecha1='+fecha1+'&fecha2='+fecha2+'&tipo='+tipo+'&id=<?=$_GET['id'];?>','','GET','cargaajax');
...
$query=mysql_query("
    ...
    WHERE autorizada_por ='".$_SESSION['user_id']."' $wFecha $id_pers 
	ORDER BY id DESC
		");
