...
function validarEmail(email) {
	...
	function validar_password() {
		...
		CargarAjax2_form('Admin/Sist.Administrador/Promotores/List/listado.php','form_edit_rec','cargaajax');
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?=$acc_text?> Promotor</h4>
</div>
          ...
          <label class="strong">Teléfono <span class="label label-important" id="Nombres" style="display:none">*</span></label>
            <div class="form-group ">
               ...
               <? if(!$_GET['id']){?>
                ...
                <input name="funcion_id" type="hidden" id="funcion_id" value="35" />
