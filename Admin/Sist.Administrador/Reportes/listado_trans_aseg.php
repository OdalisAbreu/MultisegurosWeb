          ...
          <tr>
            <td>
              ...
              <select name="aseguradora" id="aseguradora" style="display: inline; width: 170px;" class="form-control">
                ...
                <?php
                $rescat2 = mysql_query(
                  "SELECT id, nombre from seguros order by nombre ASC"
                );
              ...
              <select name="tipo" id="tipo" style="display: inline; width: 60px;" class="form-control">
                <option value="xls" <?php if (
                                      $_GET['tipo'] == 'xls'
                                    ) { ?> selected<?php } ?>>Excel</option>
                <option value="xlsx" <?php if (
                                        $_GET['tipo'] == 'xlsx'
                                      ) { ?> selected<?php } ?>>Excel Sin Formato</option>
              </select>
          ...
          <tr>
            <td>
              ...
              <?php if ($_GET['consul'] == '1') { ?>
                ...
                <?php if ($_GET['tipo'] == 'xlsx') { ?>
                  <a href="Admin/Sist.Administrador/Reportes/Export/Excel_no_headers.php?fechaDesde=<?= $fecha1 ?>&fechaHasta=<?= $fecha2 ?>&id_aseg=<?= $_GET['aseguradora'] ?>" target="_blank" class="btn btn-success">
                    <i class="fa fa-file-excel-o fa-lg" title="Descargar en Excel Sin Formato"></i>
                  </a>
                <?php } ?>
                ...
                while ($row = mysql_fetch_array($query)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                          if (
                            substr_count($reversadas1, "[" . $row['id'] . "]") > 0
                          ) {
