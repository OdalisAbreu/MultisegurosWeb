...
function FechaListPDF($id){
	  ...
	  if($fh[0] =='00'){ $hora ='12';  $T = "AM"; }
	   if($fh[0] =='01'){ $hora ='1';  $T = "AM";  }
	   if($fh[0] =='02'){ $hora ='2';  $T = "AM";  }
	   if($fh[0] =='03'){ $hora ='3';  $T = "AM";  }
	   if($fh[0] =='04'){ $hora ='4';  $T = "AM";  }
	   if($fh[0] =='05'){ $hora ='5';  $T = "AM";  }
	   if($fh[0] =='06'){ $hora ='6';   $T = "AM"; }
	   if($fh[0] =='07'){ $hora ='7';   $T = "AM"; }
	   if($fh[0] =='08'){ $hora ='8';   $T = "AM"; }
	   if($fh[0] =='09'){ $hora ='9';   $T = "AM"; }
	   if($fh[0] =='10'){ $hora ='10';   $T = "AM"; }
	   if($fh[0] =='11'){ $hora ='11';   $T = "AM"; }
	   if($fh[0] =='12'){ $hora ='12';   $T = "PM"; }
	   if($fh[0] =='13'){ $hora ='1';  $T = "PM";  }
	   if($fh[0] =='14'){ $hora ='2';  $T = "PM";  }
	   if($fh[0] =='15'){ $hora ='3';  $T = "PM";  }
	   if($fh[0] =='16'){ $hora ='4';  $T = "PM";  }
	   if($fh[0] =='17'){ $hora ='5';  $T = "PM";  }
	   if($fh[0] =='18'){ $hora ='6';  $T = "PM";  }
	   if($fh[0] =='19'){ $hora ='7';  $T = "PM";  }
	   if($fh[0] =='20'){ $hora ='8';  $T = "PM";  }
	   if($fh[0] =='21'){ $hora ='9';   $T = "PM"; }
	   if($fh[0] =='22'){ $hora ='10';  $T = "PM";  }
	   if($fh[0] =='23'){ $hora ='11';  $T = "PM";  }
	   
	   return  $f[2].'-'.$f[1].'-'.$f[0]." (".$hora.":".$fh[1].":".$fh[2]." ".$T.")";
}
