...
$R2 = mysql_query("SELECT id, nombre, activo from seguros order by nombre ASC");
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.Administrador/Revisiones/Imprimir/listado.php?tipo='+tipo+'&cedula='+cedula+'&aseguradora='+aseguradora+'&poliza='+poliza+'&consul=1','','GET','cargaajax');
  ...
  if($_GET['consul']=='1'){
	...
	if($_GET['tipo']=='2'){
		...
		$rs2 = mysql_query(
   "SELECT * FROM seguro_transacciones WHERE id_aseg = '".$_GET['aseguradora']."' AND id_poliza = '".$_GET['poliza']."' LIMIT 1");
...
<tr>
    ...
    <a href="#" onclick=" CargarAjax_win('Admin/Sist.Administrador/Revisiones/Imprimir/Accion/poliza.php?id_trans=<?=$numU['id']?>','','GET','cargaajax'); " data-title="Visualizar"  class="btn btn-danger">
