...
$rescat2 = mysql_query("SELECT * from seguros  order by nombre ASC");
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.Administrador/Revisiones/Ticket/listado.php?poliza='+poliza+'&aseg='+aseg+'&consul=1','','GET','cargaajax');
...
<table class="table table-striped table-bordered table-condensed table-white dataTable" >			
    ...
    <tr>
    	<td colspan="2" style="background-color:#FFF; text-align:right">
            ...
            <a href="javascript:" onclick="CargarAjax_win('Admin/Sist.Administrador/Revisiones/Ticket/Edit/editar-vehiculo.php?id=<?=$RQVehi['id']?>&poliza=<?=$_GET['poliza']?>&aseg=<?=$_GET['aseg']?>','','GET','cargaajax');" data-title="Editar"  class="btn btn-info">
...
<table class="table table-striped table-bordered table-condensed table-white dataTable" >			
    ...
    <tr>
    	<td colspan="2" style="background-color:#FFF; text-align:right">
            ...
            <a href="javascript:" onclick="CargarAjax_win('Admin/Sist.Administrador/Revisiones/Ticket/Edit/editar-cliente.php?id=<?=$RQClient['id']?>&poliza=<?=$_GET['poliza']?>&aseg=<?=$_GET['aseg']?>','','GET','cargaajax');" data-title="Editar"  class="btn btn-info">
