...
// EDITAR
if ($acc1 == 'Editar') {
    $consulta = "UPDATE seguro_costos SET 3meses = '" . $_POST['3meses'] . "', 6meses = '" . $_POST['6meses'] . "', 12meses = '" . $_POST['12meses'] . "' WHERE id = '" . $_POST['id'] . "'";
    @mysql_query($consulta);
    $consulta = "UPDATE valores_acordados SET costo_3meses = '" . $_POST['costo_3meses'] . "', costo_6meses = '" . $_POST['costo_6meses'] . "', costo_12meses = '" . $_POST['costo_12meses'] . "', prima_3meses = '" . $_POST['prima_3meses'] . "', prima_6meses = '" . $_POST['prima_6meses'] . "', prima_12meses = '" . $_POST['prima_12meses'] . "' WHERE id = '" . $_POST['id_valores_asociados'] . "'";
    @mysql_query($consulta);
