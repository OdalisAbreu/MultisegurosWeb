<?
	...
	$res = mysql_query("SELECT * from seguro_tarifas_backup");
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><?=$acc_text?> Servicio BACKUP</h4>
</div>
...
<div class="row">
          ...
          <label class="strong">Costos (3 Meses)</label>
            <div class="form-group ">
               <input name="3meses_costos" type="text" class="form-control" id="3meses_costos" placeholder="costos a 3 meses" onKeyPress="ValidaSoloNumeros()" value="<?=$row['3meses_costos']; ?>">
            </div>
          </div>
          ...
          <label class="strong">Costos (6 Meses)</label>
            <div class="form-group ">
               <input name="6meses_costos" type="text" class="form-control" id="6meses_costos" placeholder="costos a 6 meses" onKeyPress="ValidaSoloNumeros()" value="<?=$row['6meses_costos']; ?>">
            </div>
          </div>
          ...
          <label class="strong">Costos (12 Meses)</label>
            <div class="form-group ">
               <input name="12meses_costos" type="text" class="form-control" id="12meses_costos" placeholder="costos a 12 meses" onKeyPress="ValidaSoloNumeros()" value="<?=$row['12meses_costos']; ?>">
            </div>
          </div>
...
<div class="row">
        ...
        <div class="col-lg-6">
         <label class="strong">Subir monto en poliza (s/n)</label>
...
<? }?>
   ...
   <? 
	...
	$rescat = mysql_query("SELECT id, nombre, id_serv from seguro_tarifas_backup WHERE activo ='si' order by nombre");
   ...
   <!--mostrar las tarifas-->  
       ...
       <div id="erroruser" style="font-size:12px; color:#F00; display:none;">-Error: este usuario ya existe en nuestra base de datos.</div>
            ...
            <div class="modal-footer">
               ...
               <button name="acep" type="button" id="acep" class="btn btn-success" onClick="CargarAjax2_form('Admin/Sist.Administrador/Servicios_backup/List/listado.php','form_edit_perso','cargaajax');"><?=$acc_text?></button>
