<?
	...
	$r2 = mysql_query("SELECT * from seguro_tarifas WHERE id ='".$_GET['id']."'");
...
<form action="" method="post" enctype="multipart/form-data" id="form_edit_perso">
        ...
        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="info">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label class="strong">Nombre<span class="label label-important" id="Nombres"
                                                    style="display:none">*</span></label>
                                            <div class="form-group ">

                                                <input type="text" class="form-control" placeholder="nombre" id="nombre"
                                                    name="nombre" value="<? echo $row['nombre']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group ">
                                                <input type="text" class="form-control" placeholder="Codigo"
                                                    id="id_general_seguro" name="id_general_seguro"
                                                    value="<?=$row['id_general_seguro']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="3meses" type="text" class="form-control" id="3meses"
                                                    placeholder="precio a 3 meses" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['3meses']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="6meses" type="text" class="form-control" id="6meses"
                                                    placeholder="precio a 6 meses" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['6meses']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="12meses" type="text" class="form-control" id="12meses"
                                                    placeholder="precio a 12 meses" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['12meses']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="dpa" type="text" class="form-control" id="dpa"
                                                    placeholder="dpa" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['dpa']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="rc" type="text" class="form-control" id="rc"
                                                    placeholder="rc" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['rc']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="rc2" type="text" class="form-control" id="rc2"
                                                    placeholder="rc2" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['rc2']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                <input name="fj" type="text" class="form-control" id="fj"
                                                    placeholder="fj" onKeyPress="ValidaSoloNumeros()"
                                                    value="<?=$row['fj']; ?>">
                                            </div>
                                        </div>
            ...
            <div id="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group ">
                        <input name="placas" type="text" class="form-control" id="placas" placeholder="V,E,O,A"
                            onKeyPress="ValidaSoloNumeros()" value="<?=$row['placas']; ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button name="acep" type="button" id="acep" class="btn btn-success"
            onClick="CargarAjax2_form('Admin/Sist.Administrador/Tarifas/List/listado.php','form_edit_perso','cargaajax');"><?=$acc_text?></button>
