<?
	...
	$r2 = mysql_query("SELECT * from seguro_tarifas_backup WHERE id ='".$_GET['id']."'");
    ...
    <div class="row">
       ...
       <div id="erroruser" style="font-size:12px; color:#F00; display:none;">-Error: este usuario ya existe en nuestra base de datos.</div>
            ...
            <div class="modal-footer">
               ...
               <button name="acep" type="button" id="acep" class="btn btn-success" onClick="CargarAjax2_form('Admin/Sist.Administrador/Tarifas_backup/List/listado.php','form_edit_perso','cargaajax');"><?=$acc_text?></button>
