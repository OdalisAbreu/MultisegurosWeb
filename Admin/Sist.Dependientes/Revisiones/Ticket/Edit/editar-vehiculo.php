...
<form action="" method="post" enctype="multipart/form-data" id="form_edit_perso">
                            ...
                            <div class="row">
                                ...
                                $("#marca").change(
                                    ...
                                    function() {
                                        id = $(this).val();
                                        CargarAjax2(
                                            'Admin/Sist.Sucursal/Seguro/Vehiculos/AJAX/Modelos.php?marca_id=' +
                                            id + '', '', 'GET', 'modelo');
                                    });
                                </script>
                                <div class="col-lg-6" style="display: none;">
                                    ...
                                    <div class="form-group " >
                                        ...
                                        <div id="modelo" disabled="disabled" style="margin-left:-15px;">
                                            <select name="modelo" id="modelo" style="display:compact"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group ">
                                        <input name="chassis" type="text" class="form-control" id="chassis"
                                            placeholder="Chassis" value="<?=$row['veh_chassis']?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group ">
                                        <input name="placa" type="text" class="form-control" id="placa"
                                            placeholder="Placa" value="<?=$row['veh_matricula']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-footer">
        <button name="acep" type="button" id="acep" class="btn btn-success"
            onClick="CargarAjax2_form('Admin/Sist.Dependientes/Revisiones/Ticket/listado.php?aseg=<?=$_GET['aseg']?>&poliza=<?=$_GET['poliza']?>&consul=1','form_edit_perso','cargaajax');"><?=$acc_text?></button>

        <!--CargarAjax2_form('Admin/Sist.Dependientes/Personal/List/listado.php','form_edit_perso','cargaajax');-->
    </div>
</form>