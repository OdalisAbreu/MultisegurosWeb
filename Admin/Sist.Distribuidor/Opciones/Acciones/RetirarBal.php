<?
	...
	// 2 - 	Verificamos que el Dist. tenga balance para esta transaccion.
		...
		AudRetBal($_POST['id_pers'],$_SESSION['user_id'],$_POST['monto'],$bl_actual);
				...
				'".$balance_despues."','".$_POST['comentario']."','".$bl_actual1."','".$balance_despues2."','Retiro','".$cred_actual."')"); 
				//// MARCAMOS PARA AUDITORIA DE MONTOS AL RECARGADO
		...
		<h4><font size="4" color="#0066CC">Balance Retirado!</font></h4>
	</div>
...
<script language="JavaScript" type="text/javascript">
	...
	if (r==true){
		...
		CargarAjax2_form('Admin/Sist.Distribuidor/Opciones/Acciones/RetirarBal.php','form_edit_prof','recargar_tele'); 
...
<div class="modal-body">
    ...
    <div class="row">
          ...
          <div class="form-group input-group">
                                           ...
                                           <div class="form-group input-group">
                                             <textarea name="comentario" class="form-control" id="comentario" placeholder="Digitar comentario" style="width:379px !important;"></textarea>
