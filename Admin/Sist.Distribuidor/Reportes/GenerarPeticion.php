...
<div id="manejo" style="width: 145px;
    margin-left: 38%;
    margin-right: 50%;
...
<script>
	$( document ).ready(function() {
	  CargarAjax2('../ws2/TareasProg/GenerarReporteAseguradoraPdf_Global.php?fecha1=<?=trim($_GET['fecha1'])?>&fecha2=<?=trim($_GET['fecha2'])?>&user_id=<?=trim($_GET['user_id'])?>','','GET','manejo'); 
