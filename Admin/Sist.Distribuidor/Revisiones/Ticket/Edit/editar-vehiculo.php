...
<form action="" method="post" enctype="multipart/form-data" id="form_edit_perso">
    ...
    <div class="modal-footer">
        <button name="acep" type="button" id="acep" class="btn btn-success"
            onClick="CargarAjax2_form('Admin/Sist.Distribuidor/Revisiones/Ticket/listado.php?aseg=<?=$_GET['aseg']?>&poliza=<?=$_GET['poliza']?>&consul=1','form_edit_perso','cargaajax');"><?=$acc_text?></button>
