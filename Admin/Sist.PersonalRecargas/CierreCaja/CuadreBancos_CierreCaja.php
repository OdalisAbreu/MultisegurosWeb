<?
 ...
 // Total Recargas:
  ...
  while($retiro = mysql_fetch_array($query2)){
   ...
   $query3 = mysql_query("
  SELECT monto,id_banco FROM credito 
    ...
    <table width="100%" border="0" align="center" cellpadding="8" cellspacing="0">
      ...
      <!--  <td width="0"></td>-->
        ...
        <tr>
          <td colspan="3">
            <center>
            <input name="cal_cuadre" type="button" value="Cerrar Caja" onClick="CargarAjax2_form('Admin/Sist.PersonalRecargas/CierreCaja/CuadreBancos.php','form_cuadre','cargaajax'); " class="btn btn-primary">
            </center>
          </td>
        </tr>
    </table>
