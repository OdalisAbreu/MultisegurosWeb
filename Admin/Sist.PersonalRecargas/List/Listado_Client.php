...
if ($_GET["criterio"] !=""){ 
   ...
   $criterio = " where funcion_id IN(2,3,5) "; 
}else{
   $criterio = " where funcion_id IN(2,3,5) "; 
}
...
<tr>
    ...
    <div class="btn-group dropdown">
      <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">Seleccionar <span class="caret"></span>
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li><a href="#" onclick="CargarAjax2('Admin/Sist.PersonalRecargas/Opciones/recargadosPers.php?id=<? echo $row['id']; ?>','','GET','cargaajax');">Saldos Recargados</a></li>
    ...
    <!--recargar -->
            <a href="javascript:" onclick="CargarAjax_win('Admin/Sist.PersonalRecargas/Opciones/Acciones/Abonar.php?id=<?=$row['id']; ?>','','GET','cargaajax'); " data-title="Hacer pago"  class="btn btn-info">
             <i class="fa fa-money fa-lg" title="Hacer pago"></i> 
            </a>
    <!--recargar -->
