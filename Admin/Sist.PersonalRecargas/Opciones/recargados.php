<?
	...
	if($_GET['cliente']){
		...
		$id_pers = "AND id_pers='".$_GET['cliente']."' ";
	}
...
<div class="row" >
        ...
        <div class="filter-bar">
				...
				<table style="padding-left:3%; padding-bottom:2%; padding-top:3%;" class="table table-striped table-bordered table-hover">
                      ...
                      <tr>
                        ...
                        <input type="text" name="cliente" id="cliente" class="input-mini" value="<?=$cliente?>" style="width: 95px; height:30px; padding-bottom:2px; padding-left:5px; margin-left:5px;">
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.PersonalRecargas/Opciones/recargados.php?fecha1='+fecha1+'&fecha2='+fecha2+'&tipo='+tipo+'&cliente='+cliente+'&id=<?=$_GET['id'];?>','','GET','cargaajax');
