<?php
	...
	$directorio = "http://multiseguros.com.do/Seg_V2/images/";
	$logo = "http://multiseguros.com.do/Seg_V2/images/Aseguradora/";
...
<div id="ImprimirPoliza" align="center" >    
...
<table width="<?=$ancho?>px;"  style="font-size:12px;" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top" colspan="2" style="text-align:justify; border-top:solid 1px #000; font-size:10px !important">
...
<?
  ...
  <tr>
    ...
    <td align="left" style="border-top:solid 1px #000; border-left:solid 1px #000; border-bottom:solid 1px #000; border-right:solid 1px #000; padding-left:25px; background-color:#E0E0E0;  " valign="middle">
	
	
	
	<table style="height:25px" cellpadding="1" cellspacing="0">
	  	<tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <table align="center" cellpadding="2" style="margin-top:15px; " width="670px">
                
				<tr>
					<td width="318" valign="top" style="border-right-style: dashed; border-left-style: dashed; border-top-style: dashed; border-bottom-style: dashed; "> 
...
<table align="center" cellpadding="1" border="0" style="font-size: 12px;"> 
    ...
    <tr>
        ...
        <td align="left"><b>RD$ <?=$fj?></b></td>
					...
					<td width="316" valign="top"  style="border-right-style: dashed; border-left-style: dashed; border-top-style: dashed; border-bottom-style: dashed; "> 
					
					
					
					
<table align="center" cellpadding="1" border="0" style="font-size:11px">
  <tr>
...
<table align="center" style="margin-top: 35px; font-size: 22px; text-align: center; margin-bottom: 10px;">
    ...
    <tr>
        <td><center> <input type="button" class="btn btn-success" value="IMPRIMIR" onclick="javascript:imprSelec('ImprimirPoliza');" /></center></td>
    </tr>
</table>
