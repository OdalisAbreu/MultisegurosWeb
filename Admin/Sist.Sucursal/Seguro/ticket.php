...
<DIV ID="ImprimirTicket" align="center">
	<table style="border:solid 1px #CCC; border-radius: 10px;">
    	<tr>
    		<td>
            <!-- TABLA UNO -->
...
Gracias por elegir MultiSeguros    
  ...
  <tr>
    ...
    <tr>
    	...
    	<tr>
        	<td><center> <input type="button" value="IMPRIMIR" onclick="javascript:imprSelec('ImprimirTicket');" class="button"/></center></td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
