...
header("content-disposition: attachment;filename=Reporte de " . $_GET['nimb'] . " desde - " . $fecha1 . " - hasta - " . $fecha2 . ".xls");
...
if ($_SESSION["id_suplid"] != '1aseg') {
  $aseg = "AND id_aseg='" . $_SESSION["id_suplid"] . "' ";
  $nombre = NombreSeguroS($_SESSION["id_suplid"]);
  $clase = "1";
  $columna = "22";
  $colspan = "8";
  $colspan2 = "14";
...
<table>
  ...
  <tr>
    ...
    <td colspan="<?= $colspan2 ?>" align="center">
      <b style="font-size:23px">REPORTE DIARIO DE VENTAS 4</b>
